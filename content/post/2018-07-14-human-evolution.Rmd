...
plot8a + annotate("text", label = "3.18 - 3 mya", x = 220, y = 1.4) +
  annotate("text", label = "3.1-2.5 mya", x = 220, y = 2.4) +
  annotate("text", label = "1.88-1.5 mya", x = 220, y = 3.4) +
  annotate("text", label = "1.88-1.85 mya", x = 220, y = 4.4) +
  annotate("text", label = "1.85-1.4 mya", x = 220, y = 5.4) +
  annotate("text", label = "1.78-1.57 mya", x = 220, y = 6.4) +
  annotate("text", label = "1.7-.236 mya", x = 220, y = 7.4) +
  annotate("text", label = ".800-.130 mya", x = 220, y = 8.5) +
  annotate("text", label = ".565-.565 mya", x = 220, y = 9.4) +
  annotate("text", label = ".335-.236 mya", x = 220, y = 10.4) +
  annotate("text", label = ".250-.010 mya", x = 220, y = 11.4) +
  annotate("text", label = ".130-.040 mya", x = 220, y = 12.4) +
  annotate("text", label = "by Marc Kissel", x =1500, y =.8)
```
...
Finally, here is the data set the visualizations come from:
...
knitr::kable(cc, caption = "This is the dataset.")
```
