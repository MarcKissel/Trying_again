...
Of course, there are drawbacks to large lecture courses. One is how to assess grades. I don’t really like the idea of [grades at all](https://www.insidehighered.com/advice/2017/11/14/significant-learning-benefits-getting-rid-grades-essay) and would love the idea to have an [ungraded class](https://www.alfiekohn.org/article/case-grades/), something I may try in the future. But this semester I was stuck with figuring out a way to grade ~100 students in each of my classes. I spent awhile reading about the best way to write multiple choice questions and how many possible answers each question should have (as an aside, the history of MC tests is [amazing](http://hackeducation.com/2015/01/27/multiple-choice-testing-machines) and a [bit suprising](http://ctfd.sfsu.edu/teaching-practices/origins-and-purposes-of-multiple-choice-tests). 
