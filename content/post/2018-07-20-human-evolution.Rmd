...
plot8a + annotate("text", size =3 , label = "3.18 - 3 mya", x = 150, y = 1.4) +
  ...
  annotate("text", size =3 ,label = "1.7-.236 mya", x = 150, y = 6.4) +
  annotate("text", size =3 ,label = ".800-.130 mya", x = 150, y = 7.5) +
  annotate("text", size =3 ,label = ".565-.565 mya", x = 150, y = 8.4) +
  annotate("text", size =3 ,label = ".335-.236 mya", x = 150, y = 9.4) +
  annotate("text", size =3 ,label = ".250-.010 mya", x = 150, y = 10.4) +
  annotate("text", size =3 ,label = ".130-.040 mya", x = 150, y = 11.4) +
